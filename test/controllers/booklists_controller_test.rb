...
class BooklistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create booklist" do
    assert_difference('Booklist.count') do
      post booklists_url, params: { booklist: { ISBN: @booklist.ISBN, author: @booklist.author, genre: @booklist.genre, pages: @booklist.pages, title: @booklist.title, year: @booklist.year } }
    end
  ...
  test "should update booklist" do
    patch booklist_url(@booklist), params: { booklist: { ISBN: @booklist.ISBN, author: @booklist.author, genre: @booklist.genre, pages: @booklist.pages, title: @booklist.title, year: @booklist.year } }
